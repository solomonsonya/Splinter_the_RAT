...
public class Splinter_LOGGIE extends Thread implements Runnable
{
	...
	public void run()
	{
		...
		try
		{
			...
			Splinter_LOGGIE.pwOut_LogFile_CONVERTED.close();
			Splinter_LOGGIE.pwOut_LogFile_RAW.close();
	...
	public boolean writeLnToLog_RAW(String log)
	{
		try
		{
			Splinter_LOGGIE.pwOut_LogFile_RAW.println(log);
			Splinter_LOGGIE.pwOut_LogFile_RAW.flush();
	...
	public boolean writeLnToLog_CONVERTED(String log)
	{
		try
		{
			Splinter_LOGGIE.pwOut_LogFile_CONVERTED.println(log);
			Splinter_LOGGIE.pwOut_LogFile_CONVERTED.flush();
	...
	public boolean writeToLog_RAW(String log)
	{
		try
		{
			Splinter_LOGGIE.pwOut_LogFile_RAW.print(log);
			Splinter_LOGGIE.pwOut_LogFile_RAW.flush();
	...
	public boolean writeToLog_CONVERTED(String log)
	{
		try
		{
			Splinter_LOGGIE.pwOut_LogFile_CONVERTED.print(log);
			Splinter_LOGGIE.pwOut_LogFile_CONVERTED.flush();
