...
public class DEPRECATED_RelayBot_ForwardConnectionThread extends Thread implements Runnable, ActionListener
{
	...
	public boolean startImplant()
	{
		...
		catch(Exception e)
		{
			...
			Driver.sop("Exception caught in startImplant mtd in " + DEPRECATED_RelayBot_ForwardConnectionThread.strMyClassName + " Error msg: " + e.getLocalizedMessage());
	...
	public boolean determineCommand(String cmdLine)
	{
		try
		{
			Driver.sop("No special methods in " + DEPRECATED_RelayBot_ForwardConnectionThread.strMyClassName + " determineCommand yet");
