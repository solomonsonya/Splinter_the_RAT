...
public class Driver 
{
	...
	public static final String  VERSION = "1.600";
	
	public static boolean instance_loaded_CONTROLLER = false;
	
	public static long startTime = 0;
	
	public static volatile LinkedList<Implant_ServerSocket> llImplant_ServerSockets = null;
	...
	public static final String WEB_DROPPER = "[SPLINTER_WEB_DROPPER]";
	...
	public static final String WRITE_TO_TEMP = "WRITE TO TEMP";
	public static final String WRITE_TO_temp = "WRITE_TO_TEMP";
	public static final String WRITE_TO_DISK = "WRITE";
		...
		try
		{
			if(Driver.myHandShake == null || Driver.myHandShake.trim().equals(""))
			{
				...
				try
				{
					...
					{
						if(MapSystemProperties.strLaunchDirectory.endsWith(Driver.fileSeperator))
							CURRENT_WORKING_DIRECTORY = MapSystemProperties.strLaunchDirectory;
						else
							CURRENT_WORKING_DIRECTORY = MapSystemProperties.strLaunchDirectory + Driver.fileSeperator;
					}
